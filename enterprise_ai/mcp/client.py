...
class AgentMCPClient(MCPClient):
    ...
    def __init__(self, agent_id: str, tool_categories: Optional[List[str]] = None,
    ...
    async def update_tools(self, add_categories: Optional[List[str]] = None,
                         add_tools: Optional[List[str]] = None,
                         remove_tools: Optional[List[str]] = None) -> None:
