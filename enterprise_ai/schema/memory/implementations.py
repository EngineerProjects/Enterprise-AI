...
class ConversationMemoryFactory:
    ...
    This class provides a registry for different conversation memory
    ...
    def register(cls, name: str, memory_class: Type[ConversationMemory]) -> None:
        ...
        Args:
            ...
            memory_class: The implementation class
        """
        cls._registry[name] = memory_class

    @classmethod
    def create(cls, memory_type: str = "memory", **kwargs: Any) -> ConversationMemory:
        """
        ...
        Raises:
            ValueError: If the memory type is not registered
        """
