            ...
            for key, value in self._store.items():
                try:
                    ...
                    if hasattr(value, "to_dict") and callable(getattr(value, "to_dict")):
                        ...
                        serialized_data[key] = {"value": value, "type": type(value).__name__}
                except Exception as e:
...
class ToolMemory(NamespacedMemory):
    ...
    def store_tool_result(
        self, tool_name: str, result: ToolResult, context: Optional[Dict[str, Any]] = None
    ) -> str:
...
class MCPIntegratedMemory(NamespacedMemory):
    ...
    def __init__(
        self, session_id: Optional[str] = None, persist_path: Optional[str] = None
    ) -> None:
    ...
    def add(
        self, key: str, value: Any, namespace: Optional[str] = None, sync_with_mcp: bool = False
    ) -> None:
        """Add an item to memory.
    ...
    def store_tool_result_with_mcp(
        self, tool_name: str, result: ToolResult, context: Optional[Dict[str, Any]] = None
    ) -> str:
