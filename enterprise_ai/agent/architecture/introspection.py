...
class IntrospectionManager:
    ...
    def get_agent_info(
        self, level: Optional[IntrospectionLevel] = None
    ) -> Dict[str, Any]:
        ...
        if introspection_level == IntrospectionLevel.COMPLETE and self.config.expose_internal_structure:
    ...
    def diagnose_issue(self, issue_description: str) -> Dict[str, Any]:
        ...
        if primary_component:
            ...
            if component_health.get("healthy") is False:
                diagnosis["diagnosis"] = f"Issue appears to be related to the {primary_component} component, which is currently unhealthy."
                ...
                diagnosis["diagnosis"] = f"Issue appears to be related to the {primary_component} component, but the component seems healthy."
                diagnosis["suggested_actions"] = [
            ...
            # No clear component match
            diagnosis["diagnosis"] = "Issue description does not clearly match any specific component."
            diagnosis["suggested_actions"] = [
